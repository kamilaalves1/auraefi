...
export const AGENT_TEMPLATES: AgentTemplate[] = [
  ...
  },
  {
    ...
    description: 'Discovery and backlog: read/write docs, sessions coordination, browser research. No code execution.',
    emoji: '\ud83d\udccb',
    modelTier: 'sonnet',
    toolCount: 16,
    config: {
  ...
  },
  {
    ...
    description: 'Discovery analyst: read-only code, research, sessions visibility. No writes to the repo.',
    emoji: '\ud83d\udcca',
    modelTier: 'sonnet',
    toolCount: 12,
    config: {
  ...
  },
  {
    type: 'scrum-master',
    label: 'Scrum Master',
    description: 'Facilitation: coordinate agents and sessions, light documentation. No execution or repo patches.',
    emoji: '\ud83c\udfaf',
    modelTier: 'sonnet',
    toolCount: 16,
    config: {
  ...
  },
  {
    type: 'product-owner',
    label: 'Product Owner',
    description: 'Prioritization and stakeholder alignment: docs, sessions, research. Lightweight model tier.',
    emoji: '\ud83d\udc51',
    modelTier: 'haiku',
    toolCount: 14,
    config: {
  ...
  },
  {
    ...
    description: 'Technical design: read-only codebase, architecture notes, light web research.',
    emoji: '\ud83c\udfd7\ufe0f',
    modelTier: 'sonnet',
    toolCount: 11,
    config: {
  ...
  },
  {
    type: 'ux-designer',
    label: 'UX Designer',
    description: 'UX discovery: browser, docs, and prototypes in markdown. No shell or patches.',
    emoji: '\ud83c\udfa8',
    modelTier: 'sonnet',
    toolCount: 13,
    config: {
  ...
  },
  {
    type: 'data-engineer',
    label: 'Data Engineer',
    description: 'Pipelines and data-focused implementation with Docker bridge (same tool surface as specialist dev).',
    emoji: '\ud83e\uddf0',
    modelTier: 'sonnet',
    toolCount: 15,
    config: {
  ...
  },
  {
    ...
    description: 'Deploy and infra: full builder surface with Docker bridge (same as developer).',
    emoji: '\u2699\ufe0f',
    modelTier: 'sonnet',
    toolCount: 21,
    config: {
