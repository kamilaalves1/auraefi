...
- Session transcript handling improved across local, Hermes, aggregated gateway, and disk-backed Vertex transcript sources.
...
- Branding assets and logos for Mission Control, Vertex, Claude, Codex, and Hermes were refreshed across the interface.
